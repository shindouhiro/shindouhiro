...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=auto&height=250&section=header&text=Shindouhiro's%20World&fontSize=70&animation=fadeIn&fontAlignY=35" alt="Header" />

  <h1>👋 Hello, I'm Shindouhiro!</h1>

  <p>🚀 A passionate developer exploring the boundless possibilities of code.</p>
...
### 📊 My Tech Proficiency & Ratings

| Skill | Proficiency | Rating |
| :--- | :---: | :--- |
| **Frontend (React/Vue)** | ![90%](https://geps.dev/progress/90) | ⭐⭐⭐⭐⭐ |
| **Backend (Node/Rails)** | ![85%](https://geps.dev/progress/85) | ⭐⭐⭐⭐✬ |
| **PHP** | ![75%](https://geps.dev/progress/75) | ⭐⭐⭐⭐ |
| **System/Vim** | ![80%](https://geps.dev/progress/80) | ⭐⭐⭐⭐ |
...
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=js,react,vue,rails,php,neovim,html,css,nodejs,ts,nextjs,tailwind,postgresql,docker,git&theme=dark" />
  </a>
</div>
